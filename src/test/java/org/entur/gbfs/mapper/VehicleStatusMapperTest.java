...
class VehicleStatusMapperTest {
    ...
    void testMapVehicleStatusFile() throws IOException {
        ...
        org.entur.gbfs.v3_0.vehicle_status.GBFSVehicleStatus mapped = GBFSMapper.INSTANCE.map(testSubject, "en");
        assertDoesNotThrow(() -> {
            expect
                    .serializer("json")
    ...
    void testMapVehicleStatusFileInverse() throws IOException {
        ...
        org.entur.gbfs.v3_0.vehicle_status.GBFSVehicleStatus testSubject = objectMapper.readValue(resource, org.entur.gbfs.v3_0.vehicle_status.GBFSVehicleStatus.class);
