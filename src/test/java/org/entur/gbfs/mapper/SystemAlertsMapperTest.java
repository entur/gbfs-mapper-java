...
class SystemAlertsMapperTest {
    ...
    void testMapSystemAlertsFile() throws IOException {
        ...
        org.entur.gbfs.v3_0.system_alerts.GBFSSystemAlerts mapped = GBFSMapper.INSTANCE.map(testSubject, "en");
        assertDoesNotThrow(() -> {
            expect
                    .serializer("json")
    ...
    void testMapSystemAlertsFileInverse() throws IOException {
        ...
        org.entur.gbfs.v3_0.system_alerts.GBFSSystemAlerts testSubject = objectMapper.readValue(resource, org.entur.gbfs.v3_0.system_alerts.GBFSSystemAlerts.class);
