...
class GbfsSystemInformationFileMapperTest {
    ...
    void testMapSystemInformationFile() throws IOException {
        ...
        org.entur.gbfs.v3_0_RC.system_information.GBFSSystemInformation mapped = GbfsSystemInformationFileMapper.INSTANCE.map(testSubject, "en");
        expect
                .serializer("json")
    ...
    void testMapSystemInformationFileInverse() throws IOException {
        ...
        org.entur.gbfs.v2_3.system_information.GBFSSystemInformation mapped = GbfsSystemInformationFileMapper.INSTANCE.map(testSubject, "en");
        expect
                .serializer("json")
                .toMatchSnapshot(mapped);
    }
