...
public abstract class GeofencingZonesAdditionalMapper {
    List<org.mobilitydata.gbfs.v3_0.geofencing_zones.GBFSName> mapName(String value, @Context String language) {
        if (value == null) {
            return null;
        }
        return List.of(
    ...
    String mapNameInverse(List<org.mobilitydata.gbfs.v3_0.geofencing_zones.GBFSName> values, @Context String language) {
        if (values == null) {
            return null;
        }
